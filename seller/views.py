    ...
    if request.method == 'POST':
        ...
        if password == confirm_password:
            try:
                ...
                restaurant = Restaurant.objects.create(name=name, address=address,  picture=picture)
...
def additem(request):
    ...
    if request.method == 'POST':
        ...
        currentDish = Dish.objects.create(restaurant=restaurant, name= dish_name, summary=summary,  no_of_serving=no_of_serving, picture=picture, seller=user, price=price)
        context = {
            "message" : "Item added!", 
        }
...
def getitem(request, dish_id):
    ...
    item = {"name" : str(dish.name), "summary" : str(dish.summary), "no_of_serving" : dish.no_of_serving,"picture" : str(dish.picture),  "price":float(dish.price)}
    return JsonResponse({
        "item": item
    })
